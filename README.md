...
Stable Diffusion itself and any of its front ends have lots more features than Aubrushli_images, however I aim to give this over time the specific goal of turning shot lists into storyboards almost automatically and that means focussing on the interpretation of scripts and screenplays into prompts, rather than configuring individual images. 

The actual integration with stable diffusion is pretty light and therefore any updates or even utilising other image generators in the future should be fairly easy to incorporate.
...
Most stable diffusion things. Not even changing CFG_Scale (I leave at default, the thing is I figure if you are using for storyboards you just want to use it and not get too involved in the frankly a bit unpredictable cfg_scale). At the moment Image aspect ratio is wider than the normal (512 x 512 1:1) its 768 x 536 not quite 16:9. This is because this is aimed at storyboards and most storyboards will be wide screen. This may well cause issues on lower hardware. 
